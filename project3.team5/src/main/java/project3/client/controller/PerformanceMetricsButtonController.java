...
public class PerformanceMetricsButtonController {
	...
	/* This Constructor attaches action listener to the buttons to choose a color from a color chooser panel */
	public PerformanceMetricsButtonController(JPanel performanceMetricsPanel,JButton IN,JButton EN,JButton FO,JButton ST,JButton RE,JButton EX) {
