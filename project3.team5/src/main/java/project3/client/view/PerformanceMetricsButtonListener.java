...
/*
 * This class helps to attach various actions with the buttons in PerformanceColorPanel 
 * */
public class PerformanceMetricsButtonListener {
	...
	public PerformanceMetricsButtonListener(JPanel performanceColorPanel, JButton IN, JButton EN, JButton FO,
		...
		IN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				GraphsPropertiesModel.getGraphsPropertiesModelInstance().
				setInterestColor(IN.getBackground());
			}
		});
		EX.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				GraphsPropertiesModel.getGraphsPropertiesModelInstance().
				setExcitementColor(EX.getBackground());
		...
		EN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				GraphsPropertiesModel.getGraphsPropertiesModelInstance().
				setEngagementColor(EN.getBackground());
			}
		});
		...
		RE.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				GraphsPropertiesModel.getGraphsPropertiesModelInstance().
				setRelaxationColor(RE.getBackground());
			}
		});
