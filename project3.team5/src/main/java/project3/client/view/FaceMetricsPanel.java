...
/**
 * Tab containing Facial Expressions and corresponding graphs
 */
public class FaceMetricsPanel extends JPanel implements Observer {
	...
	/*
	 * Initialise and add corresponding image or gif based on the facial expression
	 */
	...
	/*
	 * Update face metrics panel based on the inputs
	 */
	@Override
