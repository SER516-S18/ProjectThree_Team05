...
/*
 * Contains a graph and buttons that
 * are used to plot the different performance metrics
 * */
public class PerformanceMetricsPanel extends JPanel implements Observer {
	...
	/*
	 * Initialises all components in the Performance metrics tab
	 */
	...
	/*
	 * Updating the Performance Metrics graph and setting size adn color
	 */
	@Override
