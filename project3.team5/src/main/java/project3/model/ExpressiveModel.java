...
/*
 * Class to create expressive models for all the functionalities that are being passed form the server
 * This will send only once if the autoreset is not checked and will continuously send if it is checked
 */
public class ExpressiveModel {
	...
	/*
	 * To get the boolean value to know if the server is connected
	 * 
	 * @return ServerStatus
	 */
